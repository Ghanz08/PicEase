                    ...
                    <div class="col-12">
                        <div class="display-flex">
                            <button type="button" class="battenprofile">
                                <img src="/assets/images/user/<?= $user['foto']; ?>" alt="" class="user"
                                    onclick="redirectToPage('/profile/<?= $user['id_user']; ?>')">
                            </button>
                            ...
                            <?php if (session()->get('id_user') == $foto['id_user']): ?>
                                <div class="ms-auto mt-3"> <!-- Use ms-auto to push content to the right -->
                                    <div>
                                        <button class="btn btn-detail mt-1"
                                            onclick="redirectToPage('/edit/<?= $foto['id_foto']; ?>')"><i
                                                class="fa-solid fa-gear me-1"></i> Edit Postingan</button>
                                        <button class="btn btn-detail mt-1" type="button" data-bs-toggle="modal"
                                            data-bs-target="#deleteModal"><i class="fa-solid fa-trash me-2"></i>Hapus
                                            Postingan</button>
                                        <button class="btn btn-detail mt-1" type="button" data-bs-toggle="modal"
